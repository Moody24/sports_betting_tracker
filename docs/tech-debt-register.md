...
- Ruff C901 inventory: 22 functions, down from 59 before this cleanup
...
|---|---|---|
| P1 | Remaining high-complexity workflows | 22 C901 findings remain. OCR parsing, game-total lookup, and market-line extraction are resolved; continue with the remaining model-training, upcoming-odds, and scheduler complexity-13 workflows. Preserve behavior with focused tests per extraction. |
