...
- Ruff C901 inventory: 42 functions, down from 59 before this cleanup
...
|---|---|---|
| P1 | Remaining high-complexity workflows | 42 C901 findings remain. Continue with the 20-complexity pick-context and NBA ingestion/fetch workflows. Preserve behavior with focused tests per extraction. |
